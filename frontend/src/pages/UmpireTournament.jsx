      ...
      <Dialog open={showArchiveDialog} onOpenChange={setShowArchiveDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              This will save the final results and standings, then delete the tournament data.
          ...
          <div className="flex gap-3">
            ...
            <Button onClick={archiveTournament} className="flex-1 bg-amber-500 hover:bg-amber-600">
              <Archive className="w-4 h-4 mr-2" />
              Archive & Delete
            </Button>
          </div>
